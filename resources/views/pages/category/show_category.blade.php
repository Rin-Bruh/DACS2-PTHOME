...
<div class="page-head"> 
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        ...
                        <h1 class="page-title">{{$name->category_name}}</h1>    
                        @endforeach           
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-9 padding-top-40 properties-page">
                        ...
                        <div class="section clear"> 
                            <div id="list-type" class="proerty-th">
                                @foreach($category_by_id as $key => $phong)
  ...
  overflow: hidden;"><a href="{{URL::to('/chi-tiet-phong-tro/'.$phong->phong_id)}}"> {{($phong->category_tieude)}} </a></h5>
