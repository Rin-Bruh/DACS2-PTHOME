...
<div class="slider-area">
        <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
                    ...
                    <div class="item"><img src="{{('public/frontend/assets/img/slide1/slider-image-1.jpg')}}" alt="GTA V"></div>
                    <div class="item"><img src="{{('public/frontend/assets/img/slide1/slider-image-2.jpg')}}" alt="The Last of us"></div>
                    <div class="item"><img src="{{('public/frontend/assets/img/slide1/slider-image-1.jpg')}}" alt="GTA V"></div>
        ...
        <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-12 text-center page-title">
                        ...
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sapiente blanditiis vel hic maxime ratione perferendis nostrum, culpa ad vitae voluptate quia optio placeat explicabo iusto repellendus libero aperiam nobis temporibus! . </p>
                    </div>
                </div>
