        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">PTHome</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Tài khoản của tôi</div>
              </a>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  ...
                  ?>
                  <a href="{{URL::to('/edit-chutro-info/'.$id)}}" class="menu-link">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{URL::to('/add-category-dientich')}}" class="menu-link">
                    <div data-i18n="Without menu">Khoản thu phòng</div>
                  </a>
                </li>
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{URL::to('/logoutct')}}" class="menu-link">
                ...
                <div data-i18n="Boxicons">Đăng xuất</div>
              </a>
            </li>
...
// echo"$image";
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{URL::to('/logoutct')}}">
