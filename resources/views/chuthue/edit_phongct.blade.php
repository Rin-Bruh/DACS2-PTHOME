...
<div class="app-title">
          <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="form-add-phongtro.html">Cập phòng cho thuê</a></li>
          </ul>
        </div>
    <div class="row">
                <div class="col-12">
                  <div class="card">
                    <h4 class="card-header">Cập nhật phòng cho thuê</h4>
                    @foreach($edit_phongct as $key => $edit_phong)
                        ...
                        <div class="row">
                            ...
                            <!-- Form controls -->
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                    <form action="{{URL::to('/update-phongct/'.$edit_phong->Maphongthue)}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="mb-3">
                                        ...
                                        <div>
                                            ...
                                            <textarea name="Mota" class="form-control" id="exampleFormControlTextarea1" rows="3">{{$edit_phong->Mota}}</textarea>
                                        </div>
                                        ...
                                        <button name="update_phongct" type="submit" class="btn btn-outline-success">Cập nhật</button>
                                        <a href="{{URL::to('/all-phongct/'.$edit_phong->Makhu)}}" class="btn btn-outline-danger">Hủy bỏ</a>
                                    </form>
                                    </div>
                                </div>
                                </div>
