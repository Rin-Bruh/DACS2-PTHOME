          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Danh mục cho thuê</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{URL::to('/add-category-danhmuc')}}" class="menu-link">
                    <div data-i18n="Without menu">Thêm danh mục</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{URL::to('/all-category-danhmuc')}}" class="menu-link">
                    <div data-i18n="Without navbar">Liệt kê danh mục</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Xem theo giá</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{URL::to('/add-category-theogia')}}" class="menu-link">
                    <div data-i18n="Without menu">Thêm khoảng giá</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{URL::to('/all-category-theogia')}}" class="menu-link">
                    <div data-i18n="Without navbar">Danh sách khoảng giá</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Xem theo diện tích</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{URL::to('/add-category-dientich')}}" class="menu-link">
                    <div data-i18n="Without menu">Thêm diện tích</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{URL::to('/all-category-dientich')}}" class="menu-link">
                    <div data-i18n="Without navbar">Danh sách diện tích</div>
                  </a>
                </li>
